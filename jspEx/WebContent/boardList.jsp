 ...
 <c:when test="${list.size()!=0}">
	  ...
	  <tbody class="class02">
		...
		<c:forEach var="dto" items="${list}">
		   <tr>
		     ...
		     <c:if test="${dto.re_level >1}">
			     <td >
			       <img src="/jspEx/board2/images/level.gif" height="10" width="${dto.re_level*5}">
	 ...
	 <h5 style="text-align: center">
	    ...
	    <c:forEach var="i" begin="${pdto.startPage}" 
	      ...
	      <a href="/jspEx/list.do?currentPage=${i}&currPageBlock=${pdto.currPageBlock}" 
...
<form action="content.do" name="content" 
       method="post">
